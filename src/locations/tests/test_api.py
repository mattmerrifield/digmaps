...
class RegionEndpointTests(APITestCase):
    ...
    def test_list_regions(self):
        ...
        """
        regions = self.client.get('/regions/')
        print(regions)
    ...
    def test_get_region(self):
        ...
        """
        region = self.client.get('/regions/{}'.format(self.region_1.id))
        print(region)
    ...
    def test_delete_region(self):
        ...
        """
        response = self.client.delete('/regions/{}'.format(self.region_2.id))
        print(response)
        self.assertEqual(1, models.Region.objects.count())

    def test_partial_update_region(self):
        old_text = self.region_2.description
        response = self.client.patch('/regions/{}'.format(self.region_2.id), data={
