...
class APITestCase(test.APITestCase):
    ...
    CREATE = {"name": "New Region", "description": "A land of new opportunities."}

    PARTIAL_UPDATE = {"description": "We have updated the description field here"}
    ...
    def test_create(self):
        ...
        response = self.client.post(
            "/{}/".format(self.endpoint), data=self.CREATE, format="json"
        )
    ...
    def test_partial_update(self):
        ...
        response = self.client.patch(
            "/{}/{}/".format(self.endpoint, self.object_2.id),
...
class SiteEndpointTests(APITestCase):
    ...
    CREATE = {
        ...
        "code": "abcd1234",
        "coordinates": {"latitude": 123, "longitude": 321},
    }
    PARTIAL_UPDATE = {
